...
public class ActivitiUserEntityManager extends UserEntityManager implements Session
{
    ...
    public UserEntity findUserById(String userId)
    {
        ...
        // DocumentReference userReference = new DocumentReference("xwiki", "XWiki", userId);
        // ObjectReference objectReference = new ObjectReference("XWiki.XWikiUsers", userReference);
        // String userFirstName = (String) documentAccessBridge.getProperty(objectReference, "first_name");
        // String userLastName = (String) documentAccessBridge.getProperty(objectReference, "last_name");
        // String userEmail = (String) documentAccessBridge.getProperty(objectReference, "email");
        // // String userAvatar = (String) documentAccessBridge.getProperty(objectReference, "avatar");
        // UserEntity activitiUserEntity = new UserEntity(userId);
        // activitiUserEntity.setFirstName(userFirstName);
        // activitiUserEntity.setLastName(userLastName);
        // activitiUserEntity.setEmail(userEmail);
        // return activitiUserEntity;
    }
